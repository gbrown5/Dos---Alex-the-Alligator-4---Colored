...
int yesno_box(char *str1, char *str2, char *str3);
void poll_music();
...
BITMAP *swap_screen;
int     editing;
int testing;                    // TRUE indicates playtesting a level from editor
int changed;                    // TRUE indicates map altered since last save/load
int color_text_black;   // index of main white game text
int color_text_white;   // index of main black game text
int color_scroller_text;// index of scroller text
int color_scroller_bg;  // index of scroller background
// note: many lines throughout the code were tweaked to use
//       these new color_ vars, but I left them uncommented
